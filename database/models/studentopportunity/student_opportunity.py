...
class StudentOpportunity(Base):
    ...
    opportunity_type = db.Column(db.Enum(OpportunityType))
    origin_url = db.Column(db.String(360), unique=True, nullable=False)
    source_website = db.Column(db.String(300), default=None, nullable=False)
    ...
    def __str__(self):
        return f'StudentOpportunity(id={self.id}, ' \
               ...
               f'source_website={self.source_website}, ' \
